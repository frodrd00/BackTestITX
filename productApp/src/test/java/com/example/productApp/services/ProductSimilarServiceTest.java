...
class ProductSimilarServiceTest {
    ...
    void testGetSimilarProductsReturnsCorrectDetails() {
        ...
        ProductDetail product1 = new ProductDetail("P124", "Product 124", 10.99, true);
        ProductDetail product2 = new ProductDetail("P125", "Product 125", 15.49, false);
        ...
        List<ProductDetail> result = productSimilarService.getSimilarProducts(productId);
